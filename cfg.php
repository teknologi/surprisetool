...
define("SITEURL","http://surprisetool.localhost/");
define("SITEMAIL", "Noreply <username@surprise.localhost>");
...
define("SITEISO", SITEURL.LANG_ISO."/");
...
if(isset($_SESSION['USER_ID'])) {
    ...
    if($res&&$res->num_rows==1) {
        ...
        $qry = sprintf("UPDATE users SET last_seen=NOW() WHERE id = %d;",
					   $user->id);
		$res = $db->query($qry);
